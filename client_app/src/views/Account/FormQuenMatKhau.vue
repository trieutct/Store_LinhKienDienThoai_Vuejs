    ...
    <v-dialog class="custom-dialog" transition="dialog-top-transition" width="500px">
        <v-card class="rounded-0">
            ...
            <v-card-text v-else>
                <v-row>
                    <v-col cols="12">
                        <v-text-field v-model="this.FormData.NewPass" prepend-icon="mdi-account" label="Mật khẩu mới"
                            required></v-text-field>
                    </v-col>
                    <v-col cols="12">
                        <v-text-field v-model="this.FormData.CfNewPass" prepend-icon="mdi-account" label="Nhập lại mật khẩu mới"
                            required></v-text-field>
                    </v-col>
                    <v-col cols="12">
